...
const LoginPage = () => {
        ...
        <div className="w-full lg:w-1/2 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="w-full py-2 px-4 bg-blue-500  text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                Login
              </button>
            </div>
  ...
  <Link
    to="/forgot-password"
    className="text-white bg-green-600 rounded px-4 py-2 no-underline"
  >
  Forget password?
  </Link>
</div>
